...
exports.handler = async (event) => {
  ...
  try {
    ...
    return {
      ...
      // session_id lets the browser (see index.html) later ask
      // verify-payment.js to double-check this exact session was paid,
      // before handing out an access code.
      body: JSON.stringify({ checkout_url: checkoutUrl, session_id: sessionId })
    };
  } catch (err) {
