...
// Uses gpt-image-1 at "low" quality: OpenAI's older, cheaper DALL-E 2/3
// models are no longer available on the standard API, so gpt-image-1 is
// the current option. Note: gpt-image-1 requires the OpenAI organization
// to complete OpenAI's "Verify Organization" step (platform.openai.com →
// Settings → Organization → General) before it will generate anything —
// this is separate from normal billing/account setup.
